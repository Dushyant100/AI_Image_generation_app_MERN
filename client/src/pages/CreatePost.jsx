      ...
      <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>  
        <div>
          ...
          <div className='relative bg-gray-50 border 
            ...
            focus:border-blue-500 w-64 p-3 flex-justify-center items-center'>
            {form.photo ? (
              <img 
              src={form.photo}
              alt={form.prompt}
        ...
        <div className='mt-5 flex gap-5'>
            ...
            className='text-white bg-pink-700 font-medium rounded-md text-sm
        ...
        <div className='mt-10'>
              <p className='mt-2 text-[#666e75] text-[14px]'>
                Once you have created the image you want, you can share it with others</p>
              <button type="submit" onClick={handleSubmit} className='mt-3 text-white bg-[#6469ff] font-medium rounded-md
